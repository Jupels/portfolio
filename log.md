...
## [2026-02-09] session-1770746400 (продолжение)

### Кейс: Статусы задач Blum

- Создана страница кейса `case_tasks.html`
- Добавлены CSS стили для новых модификаторов:
  - `.case-intro__accent` — акцентный текст в заголовке
  - `.case-block__desc--large` — текст 24px
  - `.case-cover__image-wrapper--centered` — центрированный обёртка
  - `.case-results--simple` — упрощённый блок результатов с dashed border
- Добавлены переводы на русском и английском в `data/ru.json`, `data/en.json`
- Обновлена ссылка на кейс на главной странице (убран Coming Soon)

### Секции кейса

- Intro: теги, заголовок с акцентом (70% → 15%)
- Team: Дизайн (2), Саппорт (2), Продукт (1)
- Role: Старший продуктовый дизайнер
- Cover: задача и результаты + главное изображение
- Problem: проблема со спиннером и валидацией
- Intersection: ограничение по бэкенду
- Context: контекст задачи
- Solutions: варианты решения
- Testing: тестирование на фокус-группе
- Colors: цветовые альтернативы
- Final: раскатка двух решений
- Results: блок с результатами (75%→15%, 3 дня)
